...
five-coefficient Lasso regression reaches $+0{,}0238$. The advantage of the simple models
is consistent in sign but does not reach statistical significance at the 5\% level.
...
$0{,}72$ ($t=1{,}82$) over a 311-week window. No candidate clears the significance
threshold fixed in advance, so the improvement is presented as directional evidence rather
